...
import al.bruno.sportify.ui.event.create.NewEventViewModel
...
val appModule = module {
    ...
    viewModel<EventViewModel> { EventViewModel(get()) }
    viewModel<NewEventViewModel> { NewEventViewModel(get()) }
}